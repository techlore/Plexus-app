...
abstract class BaseDetailsActivity : AppCompatActivity(), SortPrefsChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(activityBinding.detailsNestedScrollView) { v, windowInsets ->
            ...
            v.updatePadding(
                left = insets.left,
                right = insets.right,
                bottom = insets.bottom + convertDpToPx(this, 106f)
                // 106 = 96 + 10
                // FAB bottom margin = 96dp
        ...
        ViewCompat.setOnApplyWindowInsetsListener(activityBinding.scrollTopFab) { v, windowInsets ->
            v.updateLayoutParams<ViewGroup.MarginLayoutParams> {
                bottomMargin =
                    ...
                    convertDpToPx(this@BaseDetailsActivity, 96f)
                // 104 = 64 + 16 + 16
                // Floating toolbar height = 64dp
                // Floating toolbar bottom margin = 16dp
                // Space between FAB & floating toolbar = 16dp
            }
            WindowInsetsCompat.CONSUMED
        }
